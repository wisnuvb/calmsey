...
interface OurGoalSectionProps {
  ...
  strategyDownloadUrl?: string; // Legacy support
  strategyDownloadFiles?: DownloadFile[]; // New structure
...
export function OurGoalSection({
  ...
  strategyDownloadFiles: propStrategyDownloadFiles,
  ...
  return (
    <section className="bg-white py-16 lg:py-24" id="goal">
