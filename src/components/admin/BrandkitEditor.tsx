...
// src/components/admin/BrandkitEditor.tsx (Updated imports)
"use client";

import { useState } from "react";
import {
  SwatchIcon,
  DocumentTextIcon, // Use DocumentTextIcon instead of TypeIcon
  Bars3BottomLeftIcon, // Use this instead of SpaceBetweenHorizontallyIcon
  PhotoIcon,
  CogIcon,
...
export default function BrandkitEditor({
  ...
  const tabs = [
    ...
    { id: "spacing", name: "Spacing", icon: Bars3BottomLeftIcon },
