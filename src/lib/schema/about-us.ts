...
export const ABOUT_US_SCHEMA: PageContentSchema = {
  ...
  fields: [
    ...
    },
    {
      ...
      helpText: "Text for the action plans link (clicking opens download modal)",
    },
    {
      key: "whereWeWork.actionPlansDownloadModalTitle",
      label: "Action Plans Download Modal Title",
      type: "text",
      section: "Where We Work",
      defaultValue: "Download action plans",
    ...
    },
    {
      ...
      section: "Where We Work",
      helpText:
        "Documents for download modal. Each document has title, selector type (language/country), and file options.",
      itemLabel: "Document",
      itemSchema: [
        {
          key: "id",
        ...
        },
        {
          ...
          type: "text",
          required: true,
          placeholder: "Latin America Action Plan",
        },
        {
          key: "selectorType",
          label: "Selector Type",
          type: "select",
          required: true,
          helpText: "Dropdown shows Language or Country options",
          options: [
        ...
        },
        {
          ...
          required: true,
          itemLabel: "Option",
          helpText: "Each option: label (e.g. English) and file URL",
          itemSchema: [
            {
              key: "label",
              label: "Label",
            ...
            },
            {
              ...
              type: "file",
              required: true,
              placeholder: "/downloads/document-en.pdf",
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      helpText: "Text for the partners report link (clicking opens download modal)",
    },
    {
      key: "whereWeWork.partnersDownloadModalTitle",
      label: "Partners Download Modal Title",
      type: "text",
      section: "Where We Work",
    ...
    },
    {
      ...
      label: "Partners Download Items",
      type: "multiple",
      section: "Where We Work",
      helpText:
        "Documents for download modal. Typically one item with language options.",
      itemLabel: "Document",
      itemSchema: [
        {
          key: "id",
        ...
        },
        {
          ...
          type: "text",
          required: false,
          placeholder: "Leave empty for single document",
        },
        {
          key: "selectorType",
          label: "Selector Type",
        ...
        },
        {
          ...
          itemSchema: [
            ...
            },
            {
              ...
              type: "file",
              required: true,
              placeholder: "/downloads/report-en.pdf",
            },
          ],
        },
      ],
